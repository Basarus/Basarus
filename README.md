...
Проектирую веб- и мобильные системы, AI-инструменты, VR-решения и игровые продукты: от идеи и технической стратегии до работающей реализации.

Мне интересно не только написать код, но и понять, где проходят границы системы, как она будет развиваться, что произойдёт под нагрузкой и кто потом сможет её поддерживать.
...
![MCP](https://img.shields.io/badge/MCP-Agent_Tooling-6EA8FE?style=flat-square)
...
![A*](https://img.shields.io/badge/A*-Pathfinding-55D6BE?style=flat-square)
...
<details>
  ...
  <a href="https://github.com/Basarus/GO-Basic"><img src="https://img.shields.io/badge/Go-Basic_Experiments-00ADD8?style=for-the-badge&logo=go&logoColor=white" alt="GO-Basic repository" /></a>
  <br /><br />
